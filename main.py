...
▶ 세대 타입별 2호차 월 사용료 (아파트 7개 타입만 해당, 평형 별칭 포함)
※ 평형은 공급면적(전용+주거공용)÷3.3 기준 근사값
- 35㎡ (약 17평, 전용 35.09㎡, 124세대) → 월 32,200원
- 47㎡ (약 22평, 전용 47.99㎡, 26세대) → 월 29,600원
- 59㎡ A타입 (약 24평, 전용 59.99㎡, 463세대) → 월 26,800원
- 59㎡ B타입 (약 24평, 전용 59.99㎡, 262세대) → 월 26,600원
- 74㎡ (약 30평, 전용 74.96㎡, 93세대) → 월 23,800원
- 84㎡ A타입 (약 33평, 전용 84.97㎡, 247세대) → 월 약 22,400원 (근사; 정확한 배분면적 확인 권장)
- 84㎡ B타입 (약 33평, 전용 84.89㎡, 21세대) → 월 약 22,600원 (근사; 정확한 배분면적 확인 권장)
※ 사용자가 "24평", "33평" 등으로 질문하면 위 평형 기준으로 해당 타입을 찾아 답변할 것
※ 위 7개 타입 외 다른 평형은 이 단지에 존재하지 않음

▶ 별표1 전체 데이터 (전용면적 → 월 요금)
